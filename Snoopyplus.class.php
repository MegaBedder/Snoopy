<?php
/*
 * An extension of the Snoopy PHP. (https://github.com/rdjenkins/snoopyplus)
 ...
 * include_once "Snoopyplus.class.php";
 *
...
class Snoopyplus extends Snoopy {
	...
	public $snoopyplus_directory = "cache/";
	public $snoopyplus_cache = TRUE;

	public function is_stored($url) {
		if ($this->snoopyplus_cache) {
			$path = pathinfo(parse_url($url)['path'], PATHINFO_EXTENSION);
			$localfilename = $this->snoopyplus_directory . sha1($url) . "." . $path;
    ...
    \*======================================================================*/
	// source: http://stackoverflow.com/questions/11215440/relative-base-url-to-absolute-url/32055473#32055473
...
/*
// original example
print url2absolute('file:///path/to/some/file.html', 'another_file.php?id=5') . '<br>';

// should be an error!
print url2absolute('file:///path/to/some/file.html', '../../../../../another_file.php?id=5') . '<br>';

// with query string on base URL
print url2absolute('http://path/to/some/file.html?source=this/one', 'another_file.php?id=5') . '<br>';

// scheme relative
print url2absolute('http://path/to/some/file.html', '//other-path/another_file.php?id=5') . '<br>';
*/
