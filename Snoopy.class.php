...
class Snoopy
{
    ...
    private function _connect(&$fp)
    {
        ...
        if (!$fp) {
            ...
            switch ($errno) {
                case -3: $this->error = 'socket creation failed'; break;
                case -4: $this->error = 'dns lookup failure'; break;
                case -5: $this->error = 'connection refused or timed out'; break;
